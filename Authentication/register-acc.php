...
<?php
	...
	$q1 = mysqli_query($con, "SELECT `id` FROM `userss` WHERE `email` = '".$_REQUEST['email']."'");
	$num = mysqli_num_rows($q1);

	if ($num === 0) {

		// insert user data
		$qry = "INSERT INTO `userss` VALUES ('', '".$_REQUEST['name']."', '".$_REQUEST['email']."', '".$_REQUEST['password']."', '".$_REQUEST['gender']."', '".$_REQUEST['city']."', 'active')";
